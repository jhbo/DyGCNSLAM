...
Frame::Frame(const cv::Mat &imGray, const cv::Mat &imDepth, const double &timeStamp,  const cv::Mat &imMask,
             const cv::Mat &imRGB, GCNextractor* extractor, ORBVocabulary* voc,
             cv::Mat &K, cv::Mat &distCoef, const float &bf, const float &thDepth)
    :mImMask(imMask),mpGCNextractor(extractor), mpORBextractorLeft(static_cast<ORBextractor*>(NULL)), mpORBextractorRight(static_cast<ORBextractor*>(NULL)), mImGray(imGray),
...
Frame::Frame(const cv::Mat &imGray, const cv::Mat &imDepth, const double &timeStamp, const cv::Mat &imMask,  GCNextractor* extractor, ORBVocabulary* voc,
             cv::Mat &K, cv::Mat &distCoef, const float &bf, const float &thDepth)
    :mImMask(imMask), mpORBvocabulary(voc),mpGCNextractor(extractor),mpORBextractorLeft(static_cast<ORBextractor*>(NULL)), mpORBextractorRight(static_cast<ORBextractor*>(NULL)), mImGray(imGray),
